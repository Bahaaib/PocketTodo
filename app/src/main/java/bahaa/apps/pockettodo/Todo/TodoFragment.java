...
//                    date = mUserToDoItem.getToDoDate();
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(TodoFragment.this, year, month, day);
                if (theme.equals(MainFragment.DARKTHEME)) {
...
//                    date = mUserToDoItem.getToDoDate();
                ...
                TimePickerDialog timePickerDialog = TimePickerDialog.newInstance(TodoFragment.this, hour, minute, DateFormat.is24HourFormat(getContext()));
                if (theme.equals(MainFragment.DARKTHEME)) {
    ...
    public void setReminderTextView() {
        if (mUserReminderDate != null) {
            ...
            if (mUserReminderDate.before(new Date())) {
                Log.d("Statuss", "DATE is " + mUserReminderDate);
