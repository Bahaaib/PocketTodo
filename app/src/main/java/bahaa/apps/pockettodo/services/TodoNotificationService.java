...
import bahaa.apps.pockettodo.remainder.ReminderActivity;

import static android.content.Context.NOTIFICATION_SERVICE;

public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "todopocket.todonotificationservicetext";
    public static final String TODOUUID = "todopocket.todonotificationserviceuuid";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("Statuss", "onHandleIntent called");
